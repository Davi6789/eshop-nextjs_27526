  ...
  return (
    <div className="relative bg-gradient-to-r from-red-600 to-orange-500 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        <div
          className="absolute inset-0 bg-repeat-x animate-[slide_20s_linear_infinite]"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <span className="hidden sm:inline">
              -{discountPercent}% auf ausgewählte Produkte
            </span>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              ...
              className="bg-white px-4 py-1 rounded-full text-sm font-semibold hover:bg-gray-100 transition"

...
export default function CheckoutForm({ onSubmitSuccess }: CheckoutFormProps) {
  ...
  const { items, getDiscountedTotal, getTotalPrice, appliedCoupon, clearCart } = useCart()
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            />
            {errors.houseNumber && (
              <p className="text-sm text-red-600 mt-1">{errors.houseNumber.message}</p>
            )}
          </div>
        ...
        <div className="space-y-3">
          <label className="flex items-center gap-3 p-3 border border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Sicher und schnell bezahlen</p>
            </div>
          </label>
          ...
          <label className="flex items-center gap-3 p-3 border border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Nach Erhalt der Bestellung überweisen</p>
            </div>
          </label>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <div className="space-y-3">
          ...
          <label className="flex items-center gap-2">
            ...
            />
            <span className="text-sm text-gray-700 dark:text-gray-300">
              Ich akzeptiere die <a href="/terms" className="text-blue-600 hover:underline">AGB</a> und 
              <a href="/privacy" className="text-blue-600 hover:underline"> Datenschutzbestimmungen</a> *
            </span>
          </label>
          {errors.acceptTerms && (
      ...
      >
        {isSubmitting ? "Wird verarbeitet..." : `Jetzt ${totalAmount.toFixed(2)}€ zahlungspflichtig bestellen`}
      </button>
      ...
      {paymentMethod === "paypal" && tempOrderId && tempOrderNumber && (
        <div className="mt-4">
          ...
          <PayPalButton
            ...
            onSuccess={() => {
              clearCart()
              router.push(`/success/${tempOrderId}?orderNumber=${tempOrderNumber}&payment=paypal`)
            }}

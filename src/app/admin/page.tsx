  ...
  const loadStats = async () => {
    ...
    try {
      const res = await fetch(
        `/api/admin/stats?period=${period}&groupBy=${groupBy}`,
      );

      if (!res.ok) {
        throw new Error("Admin stats could not be loaded");
      }
      ...
      setPaymentMethodBreakdown(
        Array.isArray(data?.paymentMethodBreakdown)
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-2xl font-bold">
                ...
                icon="💰" color="text-green-500" change={12}
              </p>
            </div>

            <span
              className={`text-sm font-medium ${stats.revenueChange >= 0 ? "text-green-600" : "text-red-600"}`}
            >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <p className="text-2xl font-bold">
            {stats.totalOrders}
            icon="📦" color="text-blue-500" change={8}
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <p className="text-2xl font-bold">
            {stats.totalUsers}
            icon="👥" color="text-orange-500" change={15}
          </p>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <p className="text-xl font-bold">
              {formatPrice(customerAnalytics.avgSpentPerCustomer ?? 0)}
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xl font-bold">
              {customerAnalytics.retentionRate?.toFixed(1) || 0}%
            </p>
          </div>
        </div>
      </div>

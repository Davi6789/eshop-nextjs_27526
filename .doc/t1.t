...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Erfolgreich - zeige Bestätigungsmeldung
      setMessage({
        type: "success",
        text: data.message || "Wenn diese Email existiert, erhältst du in Kurze einen Link zum Zurücksetzen deines Passworts.",
      })

      // Leere das Email-Feld
      setEmail("")
    } catch (error) {
